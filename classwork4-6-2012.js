...
var buildMiddleWindow = function(h,w,s){
var frames = [];	
var middleWindow = [];
var grid = [];
var xGrid = s;
...
var middleWindow1 = buildMiddleWindow(2/3*yWin,xWin2,0.05);
...
var middleWindow2 = buildMiddleWindow(2/3*yWin,xWin2,0.05);
...
var middleWindow3 = buildMiddleWindow(2/3*yWin,xWin2,0.05);
...
var middleWindow4 = buildMiddleWindow(2/3*yWin,xWin2,0.05);
...
noCRed.push(sur9);
var prof10 = NUBS(S0)(2)([0,0,0,1,1,1])([point17,pointS,point171]);
var sur10 = ROTATIONAL_SURFACE(prof10);
sur10 = MAP(sur10)(domainR);
cRed.push(sur10);
var prof13 = NUBS(S0)(1)([0,0,1,1])([point171,point18]);
var sur13 = ROTATIONAL_SURFACE(prof13);
sur13 = MAP(sur13)(domainR);
noCRed.push(sur13);
var prof11 = NUBS(S0)(2)([0,0,0,1,2,2,2])([point18,point181,point19,point20]);
...
cRed.push(sur12);
var profSphere = NUBS(S0)(2)([0,0,0,1,1,1])([pointSphere1,pointSphere2,pointSphere3]);
var surSphere = ROTATIONAL_SURFACE(profSphere);
...
dome = STRUCT([roof,dome,chimney,chimney2,chimney3,chimney4]);
dome = T([0,1,2])([-3.8,11.17,6.7])(dome);
return dome;
}
