...
var decorazioneInferiore = SIMPLEX_GRID([[-spessoreFregio - 0.5,traslazioneFregio2 - spessoreFregio],[6 * hFrame],[-0.2,zFrame]]);
decorazioneInferiore = T([1])([-yFrame - hFrameLat + 0.4 - hFrame - 6*hFrame])(decorazioneInferiore);
